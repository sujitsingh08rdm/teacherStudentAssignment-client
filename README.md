...
Note:
This application does not include a registration feature. The teacher and student collections are pre-populated in the database for testing and demonstration purposes.
