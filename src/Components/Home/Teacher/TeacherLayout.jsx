...
export default function TeacherLayout() {
  ...
  return (
    ...
    //       {/* Header Row */}
    //       <div className="grid grid-cols-5 bg-gray-100 text-gray-700 font-semibold px-6 py-3">
    //         <div>Title</div>
    //         <div>Description</div>
    //         <div>Due Date</div>
    //         <div>Status</div>
    ...
    //             key={idx}
    //             className="grid grid-cols-5 items-center px-6 py-4 border-b last:border-none hover:bg-gray-50 hover:cursor-pointer"
    //           >
