...
// // import { getSubmissions } from "../../../store/assignment-slice";

// export default function Assignment() {
//   const { id } = useParams();
//   //   const { state } = useLocation(); // optional, you passed assignment from navigate
...
//   useEffect(() => {
//     dispatch(getAssignmentForTeacher(id)); // 👈 fetch submissions for this assignment
//   }, [id, dispatch]);
...
//         <h1 className="text-xl font-bold text-red-600">Assignment Detail</h1>
//       </header>
